  ...
  <div class="main-content w-full px-[var(--margin-x)] pb-8">
    ...
    >
      <div class="space-y-4 sm:space-y-5 lg:space-y-6">
        <div class="card px-4 pb-4 sm:px-5">
          <div class="my-3 flex h-8 items-center justify-between">
            ...
            <div id="labels-menu" class="inline-flex">
              <button
      ...
      <div class="space-y-4 sm:space-y-5 lg:space-y-6">
        ...
        <div class="card px-4 pb-4 sm:px-5">
          <div class="my-3 flex h-8 items-center justify-between">
            ...
            <div id="you-know-menu" class="inline-flex">
              <button
                class="popper-ref btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              >
                <svg
      ...
      <div class="space-y-4 sm:space-y-5 lg:space-y-6">
        <div class="card p-4 sm:p-5">
          ...
          <div class="mt-4 grid grid-cols-4 gap-3">
            <div class="text-center">
              ...
              <p
                class="mt-1.5 text-xs+ font-medium text-slate-700 line-clamp-1 dark:text-navy-100"
              >
                John
              </p>
            </div>
        ...
        <div class="card space-y-4 p-4 sm:p-5">
          <div class="flex items-center space-x-4">
            <div
              class="h-5 w-5 rounded border-2 bg-transparent dark:border-navy-400"
            ></div>
            <p>Not Color</p>
          </div>
          <div class="flex items-center space-x-4">
            <div
              class="h-5 w-5 rounded border-2 border-primary bg-transparent dark:border-accent"
            ></div>
            <p>Primary Color</p>
          </div>
          <div class="flex items-center space-x-4">
          ...
          <div class="flex items-center space-x-4">
            <div
              class="h-5 w-5 rounded border-2 border-info bg-transparent"
            ></div>
            <p>Info Color</p>
          </div>
          <div class="flex items-center space-x-4">
            <div
              class="h-5 w-5 rounded border-2 border-success bg-transparent"
            ></div>
            <p>Success Color</p>
          </div>
          <div class="flex items-center space-x-4">
            <div
              class="h-5 w-5 rounded border-2 border-warning bg-transparent"
            ></div>
            <p>Warning Color</p>
          </div>
          <div class="flex items-center space-x-4">
            <div
              class="h-5 w-5 rounded border-2 border-error bg-transparent"
            ></div>
            <p>Error Color</p>
          </div>
        </div>
        <div class="card px-4 pb-5 sm:px-5">
          <div class="my-3 flex h-8 items-center justify-between">
            ...
            <div id="statistic-menu" class="inline-flex">
              <button
                class="popper-ref btn -mr-1.5 h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
              >
                <svg
      ...
      <div class="space-y-4 sm:space-y-5 lg:space-y-6">
        ...
        <div class="card">
          <h3
            class="p-4 text-sm+ font-medium tracking-wide text-slate-700 dark:text-navy-100 sm:p-5"
          >
            New Followers
          </h3>
          <div
