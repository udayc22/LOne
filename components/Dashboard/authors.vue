<template>
  <div class="main-content w-full pb-8">
    ...
    >
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 lg:gap-6">
          ...
          >
            ...
            >
              <svg
                ...
                class="h-6 w-6 text-warning dark:text-white"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          >
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 text-secondary dark:text-white"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          >
            ...
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 text-success dark:text-white"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
      ...
      <div class="card">
        <div
          class="mt-3.5 flex grow items-baseline justify-between px-4 sm:px-5"
        >
          <div>
          ...
          <div
            class="badge space-x-1 rounded-full bg-success/10 py-1 px-1.5 text-success dark:bg-success/15"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-3.5 w-3.5"
      ...
      <div class="card">
        ...
        >
          ...
          <div
            class="badge space-x-1 rounded-full bg-error/10 py-1 px-1.5 text-error dark:bg-error/15"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-3.5 w-3.5"
    ...
    <div class="mt-4 sm:mt-5 lg:mt-6">
      <div
        class="flex h-8 items-center justify-between px-[var(--margin-x)] transition-all duration-[.25s]"
      >
        <h2
      ...
      <div class="mt-3 grid grid-cols-12 gap-4 sm:gap-5 lg:gap-6">
        <div
          class="mt-4 hidden pl-[var(--margin-x)] transition-all duration-[.25s] lg:col-span-3 lg:flex"
        >
          <div class="flex items-center justify-center px-3">
            <img
              class="w-full"
              src="@/assets/images/illustrations/writer.svg"
              alt="image"
            />
          </div>
        </div>
