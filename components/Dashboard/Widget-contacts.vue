  ...
  <div class="main-content w-full px-[var(--margin-x)] pb-8">
    ...
    >
      ...
      <div class="card px-4 pb-4 sm:px-5">
        ...
        <div class="mt-4 space-y-3.5" id="contact-list-accordion">
          <div class="ac [&.is-active_.ac-header_.ac-icon]:rotate-180">
            <div class="ac-header flex items-center justify-between">
              ...
              >
                <i class="ac-icon fas fa-chevron-down transition-transform"></i>
              </button>
            </div>
            <div class="ac-panel">
      ...
      <div class="card px-4 pb-4 sm:px-5">
        ...
        <div class="space-y-3.5">
          <div class="flex items-center justify-between">
            ...
            <div>
              <div
                class="badge rounded-full bg-error/10 text-error dark:bg-error/15"
              >
                Missed
              </div>
            </div>
