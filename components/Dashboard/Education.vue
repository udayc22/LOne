<template>
  ...
  <div class="main-content w-full pb-8">
    ...
    <div class="flex">
      <div
        id="courses-carousel"
        class="swiper mx-0 mt-4 px-[var(--margin-x)] transition-all duration-[.25s]"
      >
        <div class="swiper-wrapper">
          ...
          >
            <div>
              <p
                class="font-medium tracking-wide text-slate-700 line-clamp-2 dark:text-navy-100"
              >
            ...
            <div class="mt-6">
              ...
              <div
                class="mt-2 flex items-center justify-between text-primary dark:text-accent-light"
              >
    ...
    >
      <div class="card col-span-12 pb-3 lg:col-span-6">
        <div class="mt-3 flex h-8 items-center justify-between px-4 sm:px-5">
          ...
          <div id="timeline-menu" class="inline-flex">
            <button
      ...
      >
        ...
        <div class="card justify-between p-5">
          ...
          <div class="flex items-center justify-between pt-4">
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-10 w-10 text-secondary dark:text-secondary-light"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
      ...
      <div class="col-span-12 flex flex-col sm:col-span-6 lg:col-span-4">
        <div class="m-auto px-5">
          <img
            ...
            src="@/assets/images/illustrations/awards-man.svg"
            alt="image"
          />
        </div>
          ...
          <div class="card p-4">
            <div class="flex items-center space-x-3">
              <div>
                <img
                  class="h-10 w-10"
                  src="@/assets/images/awards/award-31.svg"
                  alt="image"
                />
              </div>
              <div>
          ...
          <div class="card p-4">
            <div class="flex items-center space-x-3">
              <div>
                <img
                  class="h-10 w-10"
                  src="@/assets/images/awards/award-27.svg"
                  alt="image"
                />
              </div>
              <div>
      ...
      <div class="col-span-12 sm:col-span-6 lg:col-span-4">
        <div class="flex items-center justify-between">
          ...
          <div id="group-lessons-menu" class="inline-flex">
            <button
        ...
        <div class="mt-3 flex flex-col justify-between space-y-4">
          <div class="card p-4">
            ...
            <div class="mt-2 flex items-end justify-between">
              <p
                class="flex items-center space-x-2 text-slate-400 dark:text-navy-300"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="col-span-12 lg:col-span-4">
        <div class="flex items-center justify-between">
          ...
          <div id="completed-course-menu" class="inline-flex">
            <button
              class="popper-ref btn h-8 w-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
            >
              <svg
              ...
              <div class="flex flex-1 flex-col justify-between">
                <div>
                  <a
                    ...
                    >Learn JavaScript Unit Testing</a
                  >
                  <a
                    href="#"
              ...
              <div class="flex flex-1 flex-col justify-between">
                <div>
                  <a
                    href="#"
                    class="font-medium text-slate-700 outline-none transition-colors line-clamp-2 hover:text-primary focus:text-primary dark:text-navy-100 dark:hover:text-accent-light dark:focus:text-accent-light"
                    >Sales Analytics Advanced Complete Course</a
                  >
                  <a
                    href="#"
                    class="text-xs text-slate-400 hover:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100"
