    ...
    >
      <div class="card shadow-none">
        ...
        >
          <div>
            ...
            <h3 class="mt-3 font-medium text-white line-clamp-2">Mobile App</h3>
      ...
      <div class="card shadow-none">
        ...
        >
          ...
          <div>
            <div class="mt-4">
              <p class="text-xs+ text-slate-700 dark:text-navy-100">Progress</p>
        ...
        >
          ...
          <div>
            <div class="mt-4">
              ...
              <p class="text-right text-xs+ font-medium text-secondary">52%</p>
            </div>
        ...
        >
          ...
          <div>
            <div class="mt-4">
              ...
              <p class="text-right text-xs+ font-medium text-success">33%</p>
            </div>
        ...
        >
          ...
          <div>
            <div class="mt-4">
              ...
              <p class="text-right text-xs+ font-medium text-warning">78%</p>
            </div>
