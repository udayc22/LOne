      ...
      >
        <div class="card space-y-6 p-4 sm:px-5">
          ...
          <div class="flex grow justify-between space-x-2">
            ...
            <div>
              <p class="text-xs+ text-slate-400 dark:text-navy-300">Response</p>
              <p
                class="text-lg font-semibold text-slate-700 dark:text-navy-100"
              >
                3.4 s
            ...
            <div>
              <p class="text-xs+ text-slate-400 dark:text-navy-300">Memory</p>
              <p
                class="text-lg font-semibold text-slate-700 dark:text-navy-100"
              >
                14 GB
        ...
        <div class="card space-y-6 p-4 sm:px-5">
          ...
          <div>
            <p class="text-xs uppercase">Current Status</p>
            <p class="text-base font-medium text-success">Up for 48 hours</p>
          </div>
          <div class="flex grow justify-between space-x-2">
            <div>
              <p class="text-xs+ text-slate-400 dark:text-navy-300">
        ...
        <div class="card space-y-6 p-4 sm:px-5">
          ...
          <div>
            <p class="text-xs uppercase">Current Status</p>
            <p class="text-base font-medium text-warning">Down for 6 minutes</p>
          </div>
          <div class="flex grow justify-between space-x-2">
            <div>
              <p class="text-xs+ text-slate-400 dark:text-navy-300">
