<template>
  ...
  <div class="main-content mail-app w-full px-[var(--margin-x)] pb-6">
      ...
      <div class="mt-2 flex items-center justify-between space-x-1">
        <div class="flex items-center px-2.5">
          ...
          <div id="top-header-menu" class="inline-flex">
            <button
              class="popper-ref btn -ml-1 h-5 w-5 rounded p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
            >
        ...
        <div class="flex items-center justify-between">
          <div class="flex space-x-2 sm:w-72">
            ...
            <div class="flex items-center space-x-2">
              ...
              <span
                class="h-2 w-2 shrink-0 rounded-full bg-secondary lg:hidden"
              ></span>
            </div>
          </div>
      ...
      >
        <div class="flex items-center justify-between">
          <div class="flex space-x-2 sm:w-72">
            ...
            <div class="flex items-center space-x-2">
              ...
              <span
                class="h-2 w-2 shrink-0 rounded-full bg-info lg:hidden"
              ></span>
            </div>
          </div>
        ...
        <div class="flex flex-1 items-center justify-between space-x-2">
          <div class="flex items-center space-x-2 px-2">
            ...
            <div
              class="badge hidden h-6 rounded-full border border-info text-info lg:inline-flex"
            >
              Personal
            </div>
          </div>
    ...
    <div
      class="mt-4 flex flex-col space-y-1 px-5 text-xs sm:flex-row sm:justify-between sm:space-y-0"
    >
      <a
        href="#"
        class="hover:text-slate-700 hover:underline dark:hover:text-navy-100"
        >Term &amp; Privacy</a
      >
