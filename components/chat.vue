<template>
  ...
  <div class="sidebar-panel">
    <div
      class="flex h-full grow flex-col pl-[var(--main-sidebar-width)] bg-white dark:bg-navy-750"
    >
  ...
  <main class="main-content h-100vh chat-app mt-0 flex w-full flex-col">
    ...
    >
      <div class="-ml-1.5 flex flex-1 space-x-2">
        ...
        <input
          type="text"
          class="form-input h-9 w-full rounded-md bg-transparent placeholder:text-slate-400/70"
            ...
            <div class="is-scrollbar-hidden overflow-x-auto px-4">
              <div class="tabs-list flex">
                <button
                  ...
                  data-target="#tab-media-@/assets/images"
                >
                  @/assets/images
                </button>
                <button
