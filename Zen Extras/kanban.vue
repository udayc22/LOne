<template>
  <body class="is-header-blur is-sidebar-open has-min-sidebar">
    <!-- App preloader-->
    <div
            ...
            >
              <div class="flex items-center">
                <div class="avatar mr-3 hidden h-9 w-9 lg:flex">
                  <div
                    class="is-initial rounded-full bg-success/10 text-success"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-5 w-5"
            ...
            <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
              <div class="is-scrollbar-hidden grow overflow-y-auto">
                ...
                >
                  <li>
                    <a
                      class="group flex justify-between space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                      href="#"
                    >
                ...
                <div id="sidebar-workspace">
                  <div class="ac [&.is-active_.ac-header_.ac-icon]:rotate-180">
                    <div
                      class="ac-header flex items-center justify-between px-4"
                    >
                      ...
                      <div class="-mr-1.5 flex">
                        ...
                        <button
                          class="ac-trigger btn h-6 w-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="ac-panel">
                      <ul
                        class="space-y-1.5 px-2 pt-1 font-inter text-xs+ font-medium"
                      >
                        <li>
                          <a
                            class="group flex justify-between space-x-2 rounded-lg p-2 tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600"
                          ...
                          >
                            ...
                            <span class="text-primary dark:text-accent-light"
                              >2</span
                            >
                          </a>
                        </li>
        ...
        <div class="sidebar-panel-min">
          ...
          >
            <div class="flex h-18 shrink-0 items-center justify-center">
              <div
                class="avatar flex h-10 w-10 rounded-full bg-success/10 text-success"
              >
              ...
              <div id="drawer-actions-collapse">
                <div class="ac [&.is-active_.ac-header_.ac-icon]:rotate-180">
                  ...
                  >
                    ...
                    <div class="-mr-1.5 flex">
                      <button
                        class="btn ac-trigger h-6 w-6 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="ac-icon h-3.5 w-3.5 transition-transform"
